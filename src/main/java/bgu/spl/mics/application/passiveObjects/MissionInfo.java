...
public class MissionInfo {
    ...
    public MissionInfo(String missionName, List<String> serialAgentsNumbers, List<String> agentsNames ,String gadget, int timeIssued,
			int timeExpired, int duration) {
